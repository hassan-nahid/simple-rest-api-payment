...
app.post('/api/v1/order/webhook', express_1.default.raw({ type: 'application/json' }), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // Import dynamically to avoid circular dependency
    const { OrderControllers } = yield Promise.resolve().then(() => __importStar(require('./app/modules/order/order.controller')));
